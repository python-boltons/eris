...
###############################################################################
DESCRIPTION = "The Greek Goddess of Strife and Discord... Error-handling at its finest: the better way to handle, trace, and log errors."
...
setup(
    ...
    scripts=get_scripts(),
    url="https://github.com/python-boltons/eris",
